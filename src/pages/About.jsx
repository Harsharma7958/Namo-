      ...
      <section>
        <div className={`${themeToggle ? "" : 'dark'}  about-container min-h-full dark:bg-black/95`}>
          <div className="about-intro relative overflow-hidden px-5 sm:px-10 md:px-20 py-3 md:py-6 bg-primary/50 dark:bg-black/1 flex flex-col items-center">
            ...
            <h1 className='text-center font-[Segoe_UI] text-3xl sm:text-4xl md:text-6xl tracking-tight font-bold bg-[linear-gradient(145deg,#0D4715_50%,#41644A_60%)] text-transparent bg-clip-text mb-5 dark:bg-[linear-gradient(145deg,#E9762B_50%,#41644A_60%)]'>About Us</h1>
