    ...
    return (
        <>
            <header className={`${themeToggle ? '' : 'dark'} `}>
                <div ref={navRef} className="nav-container bg-light px-5 sm:px-10 md:px-20 py-3 md:py-6 flex justify-between items-center text-secondary font-[Poppins] shadow-[0px_0px_20px_0px] dark:shadow-[0px_0px_20px_0px] z-10 dark:shadow-white dark:bg-gray-950 dark:text-primary fixed top-0 right-0 left-0">
                    ...
                    <div className="nav-left-pc hidden md:block font-semibold text-lg sticky right-0 left-0">
                        <ul className='flex gap-4 lg:gap-10 items-center'>
                            {['home', 'about', 'mantras', 'contact', 'developer'].map((element, i) => {
                                return (
                                    <li key={i}>
